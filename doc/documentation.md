# Dokumentace k maturitní práci s názvem "Rozpoznávání dopravních značek pomocí umělé inteligence s využitím jazyka Python a frameworků TensorFlow a PyTorch"
